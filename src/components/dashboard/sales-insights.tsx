...
export function SalesInsights({ data, isLoading, embedded = false }: SalesInsightsProps) {
  if (isLoading) {
    return embedded ? (
      <div className="space-y-2">
        <div className="animate-pulse h-4 w-3/4 bg-blue-800 rounded"></div>
        <div className="animate-pulse h-4 w-1/2 bg-blue-800 rounded"></div>
      </div>
    ) : (
